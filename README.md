...
2. 2.Create dataset with input features (e.g., CGPA, IQ) and target (placement status)
3. 3.Split dataset into training and testing sets
4. 4.Initialize the Logistic Regression model
5. 5.Train the model using training data
```
...
## Output:
<img width="976" height="421" alt="image" src="https://github.com/user-attachments/assets/7bd270e6-8e6c-4023-9ba7-08a2317fbc62" />
